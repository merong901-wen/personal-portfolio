...
const Footer = ({ darkMode }) => {
    ...
    const socialLinks = [
        {
            icon: Github,
            href: 'https://github.com/merong901-wen',
            label: 'GitHub',
            color: darkMode ? '#a78bfa' : '#6e5494'
        },
        {
            icon: Linkedin,
            href: 'https://linkedin.com/in/meron getachew',
            label: 'LinkedIn',
            color: darkMode ? '#60a5fa' : '#0077b5'
        },
        {
            icon: Twitter,
            href: 'https://twitter.com/meron getachew',
            label: 'Twitter',
                    ...
                    <div className="footer-main">
                        ...
                        <div className="footer-brand">
                            <div className={`brand-logo ${darkMode ? 'brand-logo-dark' : 'brand-logo-light'}`}>
                                <Code size={32} />
                                <span className={`brand-text ${darkMode ? 'brand-text-dark' : 'brand-text-light'}`}>Meron</span>
                            </div>
                        ...
                        <div ref={copyrightRef} className="footer-copyright">
                            <div className={`copyright-content ${darkMode ? 'copyright-content-dark' : 'copyright-content-light'}`}>
                                <span className={`copyright-text ${darkMode ? 'copyright-text-dark' : 'copyright-text-light'}`}>
                                    © {currentYear} Meron Getachew. Crafted with
                                </span>
