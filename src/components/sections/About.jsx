...
const AnimatedProfileImage = ({ darkMode }) => {
    ...
    return (
        <div ref={containerRef} className="profile-image-container">
            ...
            <img
                ref={imageRef}
                src="/images/meron.png"// FIXED: Changed from "persona.jpg" to "personas.jpg"
                alt="Meron - Full Stack Developer"
                        ...
                        <div className="about-text-content">
                            ...
                            >
                                <p className="description-paragraph">
                                    Hello! I'm <strong>Meron</strong>, a passionate full-stack developer with 3+ years of experience
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="highlight-text">
                                        <strong>1+years</strong> of professional experience
                                    </div>
                                </Motion.div>
