    ...
    const contactMethods = [
        {
            icon: Mail,
            label: 'Email',
            value: 'merong901@gmail.com',
            href: 'mailto:merong901@gmail.com',
                    ...
                    <div className="contact-methods">
                        ...
                        <div className={`contact-cta ${darkMode ? 'contact-cta-dark' : 'contact-cta-light'}`}>
                            ...
                            <div className="cta-buttons">
                                <a href="mailto:meron@gmail.com" className={`cta-button primary ${darkMode ? 'cta-button-primary-dark' : 'cta-button-primary-light'}`}>
                                    <Mail size={20} />
                                    <span>Email Me</span>
                                </a>
                                <a href="tel:+251900071103" className={`cta-button secondary ${darkMode ? 'cta-button-secondary-dark' : 'cta-button-secondary-light'}`}>
                                    <Phone size={20} />
                                    <span>Call Now</span>
                                </a>
                            </div>
